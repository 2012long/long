...
local 泷 = loadstring(game:HttpGet("https://raw.githubusercontent.com/JY6812/UI/refs/heads/main/81.lua"))()     
local win = 泷:new("泷脚本")
--
local UITab1 = win:Tab("『信息』",'16060333448')

local about = UITab1:section("『泷脚本』",false)
...
local UITab5 = win:Tab("『复制脚本群』",'929573644')

local about = UITab5:section("『泷脚本』",true)
...
local about = UITab20:section("『依脚本』",true)
