local CoreGui = game:GetService("StarterGui")CoreGui:SetCore("SendNotification", {    Title = "泷脚本",    Text = "耐心等待（反挂机已开启）",    Duration = 5, })print("反挂机开启")		local vu = game:GetService("VirtualUser")		game:GetService("Players").LocalPlayer.Idled:connect(function()		   vu:Button2Down(Vector2.new(0,0),workspace.CurrentCamera.CFrame)		   wait(1)		   vu:Button2Up(Vector2.new(0,0),workspace.CurrentCamera.CFrame)		end)

local OrionLib = loadstring(game:HttpGet('https://pastebin.com/raw/SePpsSPZ'))()

local Window = OrionLib:MakeWindow({Name = "泷脚本", HidePremium = false, SaveConfig = false, IntroText = "欢迎使用", ConfigFolder = "欢迎使用"})
...
Tab:AddParagraph("作者","泷")
Tab:AddLabel("此脚本长期公益")
Tab:AddLabel("作者q群929573644")
...
Tab:AddButton({
   Name = "破解白",
   Callback = function()
    getgenv().crack='魔魂随手破解'pcall(function()loadstring(request{Url='https://raw.githubusercontent.com/mohun-sciprt/normal/refs/heads/main/bc.lua',Method='GET'}.Body)()
    end
...
pcall(function()loadstring(request{Url='https://raw.githubusercontent.com/mohun-sciprt/normal/refs/heads/main/bc.lua',Method='GET'}.Body)()end)
     end
