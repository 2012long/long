...
local function createAdaptiveWatermark()
    -- 如果已有水印，先删除旧的
    if game.CoreGui:FindFirstChild("泷脚本") then
...
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "泷脚本"; Text ="载入中"; Duration = 2; })wait("3")

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "泷"; Text ="纯缝合不是特别好"; Duration = 2; })wait("2")

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "将大局逆转吧"; Text ="开"; Duration = 2; })wait("2")

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "泷"; Text ="好多功能消失了😵😵😵"; Duration = 2; })wait("2")

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "泷脚本"; Text ="载入成功"; Duration = 3; })
...
about:Label("每天不一定更新")
about:Label("感谢小依")
about:Label("感谢小依的技术指导，没她就没有泷脚本")
...
about:Button("传送到玩家旁边", function()
    ...
    if tp_player and tp_player.Character and tp_player.Character.HumanoidRootPart then
        ...
        Notify("泷", "已经传送到玩家身边", "rbxassetid://", 5)
    else
